...
useEffect(() => {
            async function Timelines(){
                const timelinedata = await fetch('https://sanctorum.in/wp-sanctorum/wp-admin/wp-json/wp/v2/pages/33');
            ...
            async function cosntructionss(){
                const constructiondata = await fetch('https://sanctorum.in/wp-sanctorum/wp-admin/wp-json/wp/v2/construction_status');
